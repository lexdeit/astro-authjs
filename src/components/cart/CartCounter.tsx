import { itemsInCart } from "@/stores/cart.store"
...
export const CartCounter = () => {
    ...
    return (
        ...
        >
            <span
                className="absolute -top-2 -right-2 flex justify-center items-center bg-blue-600 text-white text-xs rounded-full size-5"
            >
                {$itemsInCart}
            </span>
